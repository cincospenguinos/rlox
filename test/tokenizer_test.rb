...
class TokenizerTest < Test::Unit::TestCase
  ...
  test "Tokenizer#scan handles print identifier semicolon" do
    tokenizer = Rlox::Tokenizer.new("print foo;")
    assert_equal :print, tokenizer.advance_index.scan.type
    assert_equal :identifier, tokenizer.advance_index.scan.type
    assert_equal :semicolon, tokenizer.advance_index.scan.type
  end
end
